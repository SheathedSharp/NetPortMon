...
LastEditTime: 2024-09-09 23:03:16
FilePath: /Network_port traffic_monitoring_system/ui/main_window.py
Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE%E6%8E%92%E7%BA%BF
'''
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.settings = QSettings("hiddensharp429", "NetworkMonitor")
